...
// полностью настроен, доступен для операций. Счётчик с повреждённым при
// обнаружении серийным номером (буквы вместо цифр) отклоняется Gateway
// ещё на этапе опознания (2026-09-14) и вообще не доходит до Backend.
